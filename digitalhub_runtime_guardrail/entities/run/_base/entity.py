...
from digitalhub_runtime_guardrail.entities._commons.enums import Actions
...
class RunGuardrailRun(Run):
    """
    RunGuardrailRun class.
    """
    ...
    def __init__(
        ...
        kind: str,
        metadata: Metadata,
        spec: RunSpecGuardrailRun,
        status: RunStatusGuardrailRun,
        user: str | None = None,
    ) -> None:
        super().__init__(project, uuid, kind, metadata, spec, status, user)

        self.spec: RunSpecGuardrailRun
        self.status: RunStatusGuardrailRun
